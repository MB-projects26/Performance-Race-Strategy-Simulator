...
# =============================================================
#
# This is a generic overtaking-aid model.
#
# It is not intended to reproduce the exact
# sporting regulations of a particular season.
#
# =============================================================
...
#
# False:
# use the built-in synthetic dirty dataset
#
# True:
...
# Example:
#
# race_lap,lap_time,compound,pit_lap,safety_car
# 1,96.123,Medium,False,False
# 2,91.234,Medium,False,False
#
# The CSV should contain consecutive laps from
# one race.
#
# =============================================================
...
#
# If a lap is more than this amount from the
# local median, reject it.
...
calibration_training_fraction = 0.67
...
# =============================================================
#
# Keep False while using synthetic data.
#
# Only change this to True when you have
# supplied genuine external race data.
#
# =============================================================
...
# =============================================================
#
# Same model as above, but takes a simple
# True / False Safety Car flag from the dataset.
#
# =============================================================
...
# =============================================================
# SYNTHETIC DIRTY CALIBRATION DATA
# =============================================================
#
...
# - an out-lap
# - Safety Car laps
# - one large anomalous lap
#
# It exists only to test the cleaning system.
#
# =============================================================
...
def load_external_calibration_data():
    ...
    if len(rows) < 6:
        ...
        raise ValueError(
            "Not enough laps in CSV."
        )


    # Require consecutive race laps.
    #
    # This avoids silently calculating the
    # wrong tyre age if laps are missing.
...
def load_calibration_data():
    ...
    if use_external_calibration_csv:
        ...
        source = (
            "Built-in synthetic dirty dataset"
        )
...
# =============================================================
# ASSIGN STINT AND TYRE STATE
# =============================================================
#
# A new stint begins:
#
# - after a pit lap;
# - after a compound change.
#
# The tyre age and wear are calculated BEFORE
# data cleaning.
#
# This matters because removing a Safety Car lap
# does not mean the tyre magically did not age.
#
# =============================================================
...
def assign_calibration_stint_states(
    ...
    for index in range(
        ...
        # Update state after current lap
...
# =============================================================
# CHOOSE BEST CALIBRATION STINT
# =============================================================
#
# If the selected compound was used more than once,
# choose the stint with the most currently usable
# laps.
#
# =============================================================

def choose_calibration_stint(
        rows):
    ...
    for row in rows:
        ...
        if stint_id not in stint_groups:
...
# =============================================================
#
# This uses the tyre state calculated BEFORE
# filtering.
#
# Therefore:
#
# If lap 15 was removed because it was under
# Safety Car, lap 16/17 still have the correct
# tyre age and estimated wear.
#
# =============================================================
...
# =============================================================
# APPLY CALIBRATION TO MAIN MODEL
# =============================================================
...
# Only allow automatic application when
...
if apply_calibrated_model:
    ...
    if use_external_calibration_csv:
        ...
        print(
            "Reason: current dataset is synthetic."
        )
...
# =============================================================
# PRINT CALIBRATION DATA CLEANING
# =============================================================
...
if use_external_calibration_csv:
    ...
    print(
        "External race data is being used."
    )
    ...
    print(
        "This is still a synthetic calibration test."
    )
...
plt.title(
    "Raw vs Clean Calibration Dataset"
)
...
plt.title(
    "Tyre Model Calibration and Validation"
)
...
plt.xlabel(
    "Overtaking-Aid Time Gain (seconds/lap)"
)
