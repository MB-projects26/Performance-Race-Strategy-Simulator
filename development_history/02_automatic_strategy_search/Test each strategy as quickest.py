...
# Store all tyre information in one dictionary
...
def calculate_one_stop_strategy(first_base, first_deg,
    ...
    # Round result to remove tiny floating-point errors
...
def calculate_two_stop_strategy(first_base, first_deg,
    ...
    for pit_lap_1 in range(2, race_laps - 1):
        ...
        # Second pit must happen after first pit
        for pit_lap_2 in range(pit_lap_1 + 1, race_laps):
            ...
            # Check if this combination of pit laps is fastest
...
def find_best_one_stop():
    ...
    for first_tyre in tyre_names:
        ...
        for second_tyre in tyre_names:
            ...
            # Check whether this strategy is fastest
